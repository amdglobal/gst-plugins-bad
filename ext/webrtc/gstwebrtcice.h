...
#define GST_WEBRTC_ICE(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_WEBRTC_ICE, GstWebRTCICE))
#define GST_IS_WEBRTC_ICE(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_WEBRTC_ICE))
#define GST_WEBRTC_ICE_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_WEBRTC_ICE, GstWebRTCICEClass))
#define GST_IS_WEBRTC_ICE_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_WEBRTC_ICE))
#define GST_WEBRTC_ICE_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_WEBRTC_ICE, GstWebRTCICEClass))
...
void gst_webrtc_ice_add_candidate(GstWebRTCICE *ice, GstWebRTCICEStream *stream,
...
void gst_webrtc_ice_set_is_controller(GstWebRTCICE *ice, gboolean controller);
gboolean gst_webrtc_ice_get_is_controller(GstWebRTCICE *ice);
void gst_webrtc_ice_set_force_relay(GstWebRTCICE *ice, gboolean force_relay);
void gst_webrtc_ice_set_stun_server(GstWebRTCICE *ice, const gchar *uri);
gchar *gst_webrtc_ice_get_stun_server(GstWebRTCICE *ice);
void gst_webrtc_ice_set_turn_server(GstWebRTCICE *ice, const gchar *uri);
gchar *gst_webrtc_ice_get_turn_server(GstWebRTCICE *ice);

typedef void (*GstWebRTCIceOnCandidateFunc)(GstWebRTCICE *ice, guint stream_id,
                                            gchar *candidate,
                                            gpointer user_data);
